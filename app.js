...
const I18N = {
  en: {
    ...
    aboutBody:`<p>This v20.8 release restores the v17.2-style More / Help / FAQ / About support centre while preserving the v20.7 visual restoration. No Mass schedules, source data, coordinates, search rules, or Sunday-obligation logic were changed.</p>`,
  ...
  fr: {
    ...
    aboutBody:`<p>Cette version v20.8 rétablit le centre d’aide Plus / Aide / FAQ / À propos au style v17.2 tout en conservant la restauration visuelle de v20.7. Aucun horaire, source, coordonnée, règle de recherche ou logique d’obligation dominicale n’a été changé.</p>`,

...
const T={
 en:{title:'Mauritius\nMass Finder',subtitle:'Find a Mass quickly anywhere in Mauritius',search:'Search',searchPh:'afternoon Mass Curepipe, 18h, Saint Jeanâ€¦',searchHint:'Try: afternoon Mass Curepipe.',clear:'Clear',quickToday:'Today',quickTomorrow:'Tomorrow',quickMorning:'Morning',quickNear:'Near me',quickAfternoon:'Afternoon',quickSaved:'My Churches',filters:'Filters',showResults:'Show results',day:'Day',time:'Time of day',region:'Region',type:'Type',anyDay:'Any day',today:'Today',tomorrow:'Tomorrow',sunday:'Sunday',allDay:'All day',morning:'Morning',afternoon:'Afternoon',earlierToday:'Earlier today',filterSheetLabel:'Filters',detailSheetLabel:'Mass details',bottomNavLabel:'Main navigation',allRegions:'All regions',massesOnly:'Masses only',includeOther:'Include other celebrations',nextMass:'Next Mass',nextUseful:'Next useful Mass',nearTitle:'Near Me',sortedHintNear:'Near Me: grouped by urgency, then nearest first within each group',savedTitle:'My Churches',savedSub:'Your saved churches with their next Mass',noSaved:'No saved churches yet',noSavedText:'Tap Add to My Churches on a Mass card to save a church here.',results:'results',result:'result',shown:'shown',directions:'Directions',share:'Share',save:'Add to My Churches',saved:'In My Churches',source:'Source',sourceParishPage:'Parent parish page â€” {parish}',allTimes:'Parish schedule',verified:'Verified',todayRel:'Today',tomorrowRel:'Tomorrow',inM:'in {n} min',inH:'in {h}h {m}m',now:'now',startedAgo:'Started {n} min ago Â· in progress',weekdayMass:'Weekday Mass',sundayMass:'Sunday Mass',satEve:'Saturday Mass â€” generally treated as Sunday obligation from 15:00',otherCelebration:'Other celebration',approx:'~{d} km',exact:'{d} km',noResults:'No matching Mass found',noResultsText:'Try removing a filter, widening the place, or using a simpler search.',noExactTimeMatch:'No Mass within 15 minutes of {time}.',noExactTimeMatchText:'Try another time or remove the exact-time search to browse the schedule.',locationAsk:'Allow location access to sort nearby Masses.',locationDenied:'Location was not available. Results remain sorted by next Mass.',nearUse:'Use my location',moreTitle:'Help & app information',helpTitle:'How to use this app',helpHtml:'<div class="faq"><p><b>Quick tips:</b> try â€œmorning Mass Curepipeâ€, â€œafternoon Mass Curepipeâ€, â€œWednesday afternoonâ€, or â€œ18:00â€. A few words are enough.</p><details open><summary>Finding a Mass</summary><p>Search by town, parish, church name, weekday, time, or simple keywords such as â€œmorning Curepipeâ€, â€œWednesday afternoonâ€, â€œafternoon Mass Curepipeâ€, â€œCurepipe 18:00â€, or â€œsaint jeanâ€. Morning means before 12:00. Afternoon means 12:00 onward. You can also type â€œevening Massâ€; the app will search afternoon Masses.</p></details><details><summary>Using filters</summary><p>Filters help you narrow results quickly. You can filter by day, time of day, region, and type of celebration.</p><p><b>Examples:</b> Today + Afternoon; Tomorrow + Morning; Region + Afternoon; Masses only / Include other celebrations.</p><p><b>Tip:</b> use filters when you want to browse. Use search when you already know a place or time.</p></details><details><summary>Near Me</summary><p>Near Me uses your device location to rank upcoming Masses. Approximate distances are shown with â€œ~â€.</p></details><details><summary>My Churches</summary><p>Add to My Churches saves the church/site so you can find its next Mass quickly. It does not save one single Mass occurrence. Saved churches normally remain after app updates.</p></details><details><summary>Other celebrations</summary><p>The default view shows Masses only. Prayer services, adoration, or ambiguous celebrations appear only when you include other celebrations.</p></details><details><summary>Saturday / Sunday</summary><p>Saturday Masses from 3:00 pm are generally treated as Sunday obligation. The app therefore includes them in Sunday Mass searches and filters.</p></details><details><summary>Sources and reliability</summary><p>Use Source to check the official parish or context page. If an item looks wrong, use Report an issue.</p></details><details><summary>Updates and offline use</summary><p>Use the update banner when it appears. Saved churches are stored on your device and normally survive updates. Offline mode uses the last available app data.</p></details></div>',trustTitle:'Trust note',trustText:'Mass times can change for feast days, funerals, cyclones, holidays or parish changes. Use the source link when timing is critical.',version:'Version',navHome:'Home',navNear:'Near me',navSaved:'My Churches',navMore:'More',updateTitle:'New version available',updateText:'Update to get the latest version.',refresh:'Update now',later:'Later',copied:'Link copied',shared:'Ready to share',shareAppTitle:'Mauritius Mass Finder',shareMassIntro:'Mass time',howUpdate:'How to update',troubleUpdating:'Having trouble updating?',about:'About',aboutTitle:'About this app',aboutHtml:'<p><b>Purpose:</b> Mauritius Mass Finder helps people quickly find Catholic Mass times across Mauritius.</p><p><b>Data and trust:</b> the schedule is based on the maintained project database compiled from official diocesan parish information and project corrections. Church schedules can still change at short notice.</p><p><b>Default view:</b> the app shows Masses only by default. Other celebrations, such as adoration or prayer services, are shown only when you choose to include them.</p><p><b>Corrections:</b> if a time looks wrong, use the source link or Report an issue so the database can be corrected.</p>',updateGuideTitle:'How to update the app',updateGuideHtml:'<p>When a new version is available, a message will appear:</p><p><b>â†’ New version available</b></p><p>Tap <b>Update now</b> to load the latest version.</p><p><b>If nothing happens:</b></p><ol><li>Close the app completely</li><li>Reopen it</li></ol><p><b>If the problem continues:</b></p><ul><li>remove the app from your home screen</li><li>add it again from your browser</li></ul>',swipeHint:'Swipe to see more',showingToday:'Showing: Today',showingTomorrow:'Showing: Tomorrow',showingSunday:'Showing: Sunday Masses (including Saturday Masses from 3:00 pm)',showingNear:'Showing: Near you',showingSaved:'Showing: My Churches',showingSearch:'Showing: Search results',locationNotEnabled:'Location not enabled',sortedHint:'Sorted by time, then distance',updateFallback:'If nothing happens, close and reopen the app.',reportIssue:'Report an issue',reportSubject:'Correction for Mauritius Mass Finder',reportBody:'Please check this Mass information:',resultCap:'Showing 60 of {n} â€” refine your search.',sundayExplain:'Saturday Masses from 3:00 pm are generally treated as Sunday obligation.',details:'Details',sourceAvailable:'Official source available',approxLocation:'Approx. location',exactLocation:'Exact location',confidenceLow:'Lower confidence â€” check source',confidenceOk:'Confidence {score}%',onlyWhen:'{rule}',exceptWhen:'{rule}',notMassWarning:'Other celebration â€” not a Mass',parishSchedule:'Parish schedule',detailTitle:'Mass details',rule:'Rule',parish:'Parish',site:'Church',town:'Town',invalidLink:'Shared link could not be fully restored',installTab:'Install the app',installPromptTitle:'Install the app in 30 seconds',installPromptBody:'Add Mauritius Mass Finder to your Home Screen so you can open it like a real app, without searching for the link.',installPromptIphoneShort:'On iPhone: open this page in Safari, tap Share, then choose â€œAdd to Home Screenâ€.',installPromptAndroidShort:'On Android: open this page in Chrome, tap â‹®, then choose â€œInstall appâ€ or â€œAdd to Home screenâ€.',howInstall:'See the steps',installNow:'Install now',firstStandaloneTitle:'The app is installed',firstStandaloneBody:'You can now open Mauritius Mass Finder directly from your Home Screen. To get started, search for a town, a church, or a Mass time.',start:'Start',seeHowUse:'See how to use the app',iphoneInstallTitle:'On iPhone',iphoneInstallStep1:'Open this page in Safari.',iphoneInstallStep2:'Tap the Share button.',iphoneInstallStep3:'Choose â€œAdd to Home Screenâ€.',iphoneInstallStep4:'Tap â€œAddâ€.',androidInstallTitle:'On Android',androidInstallStep1:'Open this page in Chrome.',androidInstallStep2:'Tap â‹®.',androidInstallStep3:'Choose â€œAdd to Home screenâ€ or â€œInstall appâ€.',androidInstallStep4:'Confirm.',openSafariFirst:'To install the app on iPhone, first open this link in Safari.',browserUseNote:'You can also use this app in your browser. For phone use, open the link on your phone and add it to your Home Screen.',installedUseNote:'Ready to use from your Home Screen.',shareAppText:'Find a Mass quickly anywhere in Mauritius. Open the link and add it to your Home Screen for app-like access.',loadDataError:'We could not load the latest Mass data. Please check your connection and try again.',skipResults:'Skip to results',staleDataNotice:'Showing saved data â€” connect to check for updates.',error:'Something went wrong'},
 fr:{title:'Trouver une\nMesse Ã  Maurice',subtitle:'Trouvez rapidement une messe Ã  Maurice',search:'Recherche',searchPh:'messe aprÃ¨s-midi Curepipe, 18h, Saint Jeanâ€¦',searchHint:'Essayez : messe aprÃ¨s-midi Curepipe.',clear:'Effacer',quickToday:'Aujourdâ€™hui',quickTomorrow:'Demain',quickMorning:'Matin',quickNear:'PrÃ¨s de moi',quickAfternoon:'AprÃ¨s-midi',quickSaved:'Mes Ã©glises',filters:'Filtres',showResults:'Afficher les rÃ©sultats',day:'Jour',time:'Moment',region:'RÃ©gion',type:'Type',anyDay:'Tous les jours',today:'Aujourdâ€™hui',tomorrow:'Demain',sunday:'Dimanche',allDay:'Toute la journÃ©e',morning:'Matin',afternoon:'AprÃ¨s-midi',earlierToday:'Plus tÃ´t aujourdâ€™hui',filterSheetLabel:'Filtres',detailSheetLabel:'DÃ©tails de la messe',bottomNavLabel:'Navigation principale',allRegions:'Toutes les rÃ©gions',massesOnly:'Messes uniquement',includeOther:'Inclure autres cÃ©lÃ©brations',nextMass:'Prochaine messe',nextUseful:'Prochaine messe utile',nearTitle:'PrÃ¨s de moi',sortedHintNear:'PrÃ¨s de moi : groupÃ© par urgence, puis plus proche dâ€™abord dans chaque groupe',savedTitle:'Mes Ã©glises',savedSub:'Vos Ã©glises enregistrÃ©es avec leur prochaine messe',noSaved:'Aucune Ã©glise enregistrÃ©e',noSavedText:'Appuyez sur Ajouter Ã  Mes Ã©glises pour enregistrer une Ã©glise ici.',results:'rÃ©sultats',result:'rÃ©sultat',shown:'affichÃ©s',directions:'ItinÃ©raire',share:'Partager',save:'Ajouter Ã  Mes Ã©glises',saved:'Dans Mes Ã©glises',source:'Source',sourceParishPage:'Page de la paroisse mÃ¨re â€” {parish}',allTimes:'Horaires de la paroisse',verified:'VÃ©rifiÃ©',todayRel:'Aujourdâ€™hui',tomorrowRel:'Demain',inM:'dans {n} min',inH:'dans {h}h {m}m',now:'maintenant',startedAgo:'CommencÃ©e il y a {n} min Â· en cours',weekdayMass:'Messe de semaine',sundayMass:'Messe du dimanche',satEve:'Messe du samedi â€” gÃ©nÃ©ralement messe anticipÃ©e du dimanche Ã  partir de 15h',otherCelebration:'Autre cÃ©lÃ©bration',approx:'~{d} km',exact:'{d} km',noResults:'Aucune messe trouvÃ©e',noResultsText:'Essayez de retirer un filtre, dâ€™Ã©largir le lieu ou dâ€™utiliser une recherche plus simple.',noExactTimeMatch:'Aucune messe Ã  moins de 15 minutes de {time}.',noExactTimeMatchText:'Essayez une autre heure ou retirez la recherche par heure prÃ©cise pour consulter les horaires.',locationAsk:'Autorisez la localisation pour trier les messes proches.',locationDenied:'La localisation nâ€™est pas disponible. Les rÃ©sultats restent triÃ©s par prochaine messe.',nearUse:'Utiliser ma localisation',moreTitle:'Aide et informations',helpTitle:'Comment utiliser cette application',helpHtml:'<div class="faq"><p><b>Conseils rapides :</b> essayez Â« messe matin Curepipe Â», Â« messe aprÃ¨s-midi Curepipe Â», Â« mercredi aprÃ¨s-midi Â» ou Â« 18h Â». Quelques mots suffisent.</p><details open><summary>Trouver une messe</summary><p>Recherchez par ville, paroisse, nom dâ€™Ã©glise, jour, heure ou mots simples comme Â« matin Curepipe Â», Â« mercredi aprÃ¨s-midi Â», Â« messe aprÃ¨s-midi Curepipe Â», Â« Curepipe 18h Â» ou Â« saint jean Â». Matin signifie avant 12h. AprÃ¨s-midi signifie Ã  partir de 12h. Vous pouvez aussi Ã©crire Â« messe du soir Â» : lâ€™application cherchera les messes de lâ€™aprÃ¨s-midi.</p></details><details><summary>Utiliser les filtres</summary><p>Les filtres vous aident Ã  rÃ©duire rapidement les rÃ©sultats. Vous pouvez filtrer par jour, moment de la journÃ©e, rÃ©gion et type de cÃ©lÃ©bration.</p><p><b>Exemples :</b> Aujourdâ€™hui + AprÃ¨s-midi ; Demain + Matin ; RÃ©gion + AprÃ¨s-midi ; Messes uniquement / Inclure les autres cÃ©lÃ©brations.</p><p><b>Conseil :</b> utilisez les filtres pour parcourir les rÃ©sultats. Utilisez la recherche si vous connaissez dÃ©jÃ  un lieu ou un horaire.</p></details><details><summary>PrÃ¨s de moi</summary><p>PrÃ¨s de moi utilise la localisation de votre appareil pour classer les prochaines messes. Les distances approximatives sont affichÃ©es avec Â« ~ Â».</p></details><details><summary>Mes Ã©glises</summary><p>Ajouter Ã  Mes Ã©glises enregistre lâ€™Ã©glise ou le lieu pour retrouver rapidement sa prochaine messe. Cela nâ€™enregistre pas une seule occurrence de messe. Les Ã©glises enregistrÃ©es restent normalement aprÃ¨s les mises Ã  jour.</p></details><details><summary>Autres cÃ©lÃ©brations</summary><p>Par dÃ©faut, lâ€™application affiche uniquement les messes. Les temps de priÃ¨re, adorations ou cÃ©lÃ©brations ambiguÃ«s apparaissent seulement si vous choisissez dâ€™inclure les autres cÃ©lÃ©brations.</p></details><details><summary>Samedi / dimanche</summary><p>Les messes du samedi Ã  partir de 15h sont gÃ©nÃ©ralement traitÃ©es comme messes anticipÃ©es du dimanche. Lâ€™application les inclut donc dans les recherches et filtres du dimanche.</p></details><details><summary>Sources et fiabilitÃ©</summary><p>Utilisez Source pour vÃ©rifier la page officielle ou la page de contexte de la paroisse. Si une information semble incorrecte, utilisez Signaler un problÃ¨me.</p></details><details><summary>Mises Ã  jour et mode hors ligne</summary><p>Utilisez la banniÃ¨re de mise Ã  jour lorsquâ€™elle apparaÃ®t. Les Ã©glises enregistrÃ©es sont stockÃ©es sur votre appareil et restent normalement aprÃ¨s les mises Ã  jour. Le mode hors ligne utilise les derniÃ¨res donnÃ©es disponibles.</p></details></div>',trustTitle:'Note de confiance',trustText:'Les horaires peuvent changer en cas de fÃªtes, funÃ©railles, cyclones, jours fÃ©riÃ©s ou changement paroissial. Utilisez le lien source lorsque lâ€™horaire est important.',version:'Version',navHome:'Accueil',navNear:'PrÃ¨s de moi',navSaved:'Mes Ã©glises',navMore:'Plus',updateTitle:'Nouvelle version disponible',updateText:'Actualisez pour obtenir la derniÃ¨re version.',refresh:'Actualiser',later:'Plus tard',copied:'Lien copiÃ©',shared:'PrÃªt Ã  partager',shareAppTitle:'Trouver une Messe Ã  Maurice',shareMassIntro:'Horaire de messe',howUpdate:'Comment mettre Ã  jour',troubleUpdating:'ProblÃ¨me de mise Ã  jour ?',about:'Ã€ propos',aboutTitle:'Ã€ propos de cette application',aboutHtml:'<p><b>Objectif :</b> Trouver une Messe Ã  Maurice aide Ã  trouver rapidement les horaires des messes catholiques Ã  Maurice.</p><p><b>DonnÃ©es et confiance :</b> les horaires viennent de la base de donnÃ©es du projet, Ã©tablie Ã  partir des informations paroissiales officielles du diocÃ¨se et des corrections vÃ©rifiÃ©es du projet. Les horaires peuvent toutefois changer Ã  court terme.</p><p><b>Affichage par dÃ©faut :</b> lâ€™application affiche uniquement les messes par dÃ©faut. Les autres cÃ©lÃ©brations, comme lâ€™adoration ou les temps de priÃ¨re, apparaissent seulement si vous choisissez de les inclure.</p><p><b>Corrections :</b> si un horaire semble incorrect, utilisez le lien source ou Signaler un problÃ¨me afin que la base puisse Ãªtre corrigÃ©e.</p>',updateGuideTitle:'Comment mettre Ã  jour lâ€™application',updateGuideHtml:'<p>Lorsquâ€™une nouvelle version est disponible, un message sâ€™affiche :</p><p><b>â†’ Nouvelle version disponible</b></p><p>Appuyez sur <b>Actualiser</b> pour charger la derniÃ¨re version.</p><p><b>Si cela ne fonctionne pas :</b></p><ol><li>Fermez complÃ¨tement lâ€™application</li><li>Rouvrez-la</li></ol><p><b>Si le problÃ¨me persiste :</b></p><ul><li>supprimez lâ€™application de votre Ã©cran dâ€™accueil</li><li>ajoutez-la Ã  nouveau depuis le navigateur</li></ul>',swipeHint:'Faites glisser pour voir plus',showingToday:'Affichage : Aujourdâ€™hui',showingTomorrow:'Affichage : Demain',showingSunday:'Affichage : Messes du dimanche (y compris les messes du samedi Ã  partir de 15h)',showingNear:'Affichage : PrÃ¨s de vous',showingSaved:'Affichage : Mes Ã©glises',showingSearch:'Affichage : RÃ©sultats de recherche',locationNotEnabled:'Localisation non activÃ©e',sortedHint:'TriÃ© par heure, puis distance',updateFallback:'Si rien ne se passe, fermez puis rouvrez lâ€™application.',reportIssue:'Signaler un problÃ¨me',reportSubject:'Correction pour Trouver une Messe Ã  Maurice',reportBody:'Merci de vÃ©rifier cette information de messe :',resultCap:'60 rÃ©sultats affichÃ©s sur {n} â€” affinez votre recherche.',sundayExplain:'Ã€ Maurice, les messes du samedi Ã  partir de 15h sont gÃ©nÃ©ralement des messes anticipÃ©es du dimanche.',details:'DÃ©tails',sourceAvailable:'Source officielle disponible',approxLocation:'Localisation approx.',exactLocation:'Localisation exacte',confidenceLow:'Confiance plus faible â€” vÃ©rifiez la source',confidenceOk:'Confiance {score}%',onlyWhen:'{rule}',exceptWhen:'{rule}',notMassWarning:'Autre cÃ©lÃ©bration â€” pas une messe',parishSchedule:'Horaires de la paroisse',detailTitle:'DÃ©tails de la messe',rule:'Condition',parish:'Paroisse',site:'Ã‰glise',town:'Ville',invalidLink:'Le lien partagÃ© nâ€™a pas pu Ãªtre entiÃ¨rement restaurÃ©',installTab:'Installer lâ€™application',installPromptTitle:'Installer lâ€™app en 30 secondes',installPromptBody:'Ajoutez Mauritius Mass Finder Ã  votre Ã©cran dâ€™accueil pour lâ€™ouvrir comme une vraie app, sans devoir rechercher le lien.',installPromptIphoneShort:'Sur iPhone : ouvrez cette page dans Safari, appuyez sur Partager, puis choisissez Â« Ajouter Ã  lâ€™Ã©cran dâ€™accueil Â».',installPromptAndroidShort:'Sur Android : ouvrez cette page dans Chrome, appuyez sur â‹®, puis choisissez Â« Installer lâ€™application Â» ou Â« Ajouter Ã  lâ€™Ã©cran dâ€™accueil Â».',howInstall:'Voir les Ã©tapes',installNow:'Installer maintenant',firstStandaloneTitle:'Lâ€™app est installÃ©e',firstStandaloneBody:'Vous pouvez maintenant ouvrir Mauritius Mass Finder directement depuis votre Ã©cran dâ€™accueil. Pour commencer, recherchez une ville, une Ã©glise ou une heure de messe.',start:'Commencer',seeHowUse:'Voir comment utiliser lâ€™app',iphoneInstallTitle:'Sur iPhone',iphoneInstallStep1:'Ouvrez cette page dans Safari.',iphoneInstallStep2:'Appuyez sur le bouton Partager.',iphoneInstallStep3:'Choisissez Â« Ajouter Ã  lâ€™Ã©cran dâ€™accueil Â».',iphoneInstallStep4:'Appuyez sur Â« Ajouter Â».',androidInstallTitle:'Sur Android',androidInstallStep1:'Ouvrez cette page dans Chrome.',androidInstallStep2:'Appuyez sur â‹®.',androidInstallStep3:'Choisissez Â« Ajouter Ã  lâ€™Ã©cran dâ€™accueil Â» ou Â« Installer lâ€™application Â».',androidInstallStep4:'Confirmez.',openSafariFirst:'Pour installer lâ€™app sur iPhone, ouvrez dâ€™abord ce lien dans Safari.',browserUseNote:'Vous pouvez aussi utiliser cette application dans votre navigateur. Pour lâ€™utiliser sur tÃ©lÃ©phone, ouvrez le lien sur votre tÃ©lÃ©phone et ajoutez-la Ã  lâ€™Ã©cran dâ€™accueil.',installedUseNote:'PrÃªte Ã  Ãªtre utilisÃ©e depuis votre Ã©cran dâ€™accueil.',shareAppText:'Trouvez rapidement une messe Ã  Maurice. Ouvrez le lien et ajoutez-le Ã  votre Ã©cran dâ€™accueil pour lâ€™utiliser comme une app.',loadDataError:'Impossible de charger les derniers horaires de messe. VÃ©rifiez votre connexion puis rÃ©essayez.',skipResults:'Aller aux rÃ©sultats',staleDataNotice:'DonnÃ©es enregistrÃ©es â€” connectez-vous pour vÃ©rifier les mises Ã  jour.',error:'Une erreur est survenue'}
};
...
const state={query:'',parsed:{},filters:{...DEFAULT_FILTERS},location:null,near:false,nearExpanded:false,nearScope:'',mode:'home',moreSection:'help',modal:null,saved:new Set(),lang:'en',rows:[],results:[],next:null,loadError:'',dataStale:false,dataSource:'',detailRow:null,exactTimeStatus:null};
...
function norm(s){return String(s||'').normalize('NFD').replace(/[\u0300-\u036f]/g,'').replace(/[Å“Å’]/g,'oe').toLowerCase().replace(/[â€™'`Â´-]/g,' ').replace(/\b(st)\b/g,'saint').replace(/\b(ste)\b/g,'sainte').replace(/\b(nd)\b/g,'notre dame').replace(/[^a-z0-9]+/g,' ').trim()}
...
function visibleSiteName(r){
  ...
  else suffix=[town,parish&&norm(parish)!==norm(base)?parish:'',region].filter(Boolean).slice(0,2).join(' Â· ');
  return suffix?`${base} â€” ${suffix}`:base;
}
...
function isNearIntentText(n){
  const s=' '+normaliseSearchText(n)+' ';
  if(hasAnyPhrase(s,['near me','nearby mass','mass nearby','nearby','closest mass','mass closest to me','around me','close to me','mass close to me','pres de moi','prÃ¨s de moi','proche de moi','a proximite','Ã  proximitÃ©','aux alentours','autour de moi']))return true;
  // French users often say â€œmesse proche maintenantâ€; treat â€œprocheâ€ as current-location intent only when no explicit place remains.
  if(/\b(proche|proximite|proximitÃ©)\b/.test(s)&&/\b(messe|mass|maintenant|now)\b/.test(s)&&!/(curepipe|port louis|quatre bornes|rose hill|vacoas|floreal|florÃ©al|mahebourg|mahÃ©bourg|grand baie|beau bassin|moka|goodlands|triolet|souillac|flic en flac|bambous|riviere|riviÃ¨re|plaines|wilhems)\b/.test(s))return true;
  // Do not treat â€œMass near Curepipeâ€ as current-location Near Me; that is a place search.
  return false;
}
function isEveningIntentText(n){return hasAnyPhrase(n,['evening','soir','soiree','soirÃ©e','tonight','ce soir'])}
function removeNearIntentFromQuery(q){
  ...
  const nearPhrases=[
    ...
    'prÃ¨s de moi maintenant','pres de moi maintenant','prÃ¨s de moi','pres de moi','proche de moi maintenant','proche de moi','messe proche maintenant',
    'Ã  proximitÃ© maintenant','a proximite maintenant','Ã  proximitÃ©','a proximite','aux alentours','autour de moi','messe autour de moi'
  ];
  s=semanticReplaceNormalized(s,nearPhrases);
  s=s.replace(/\b(nearby|closest)\b/gi,' ');
  // Preserve explicit place searches such as â€œMass near Curepipeâ€ / â€œmesse prÃ¨s de Curepipeâ€.
  s=s.replace(/\b(near|prÃ¨s|pres|proche|proximite|proximitÃ©|around|autour)\s+(me|moi)\b/gi,' ');
...
function preservedVisibleQueryWithoutNear(q){
  ...
  else if(parsed.time==='afternoon')parts.push(state.lang==='fr'?'aprÃ¨s-midi':'afternoon');
  if(parsed.exactLabel)parts.push(parsed.exactLabel);
  if(parsed.day==='today')parts.push(state.lang==='fr'?'aujourdâ€™hui':'today');
...
function stripStopwords(text){const stop=/\b(this|in|at|on|for|to|i|want|need|find|show|get|please|me|a|an|the|mass|masses|church|churches|du|de|des|le|la|les|l|au|aux|d|en|ce|cet|cette|dans|pour|je|veux|cherche|trouver|montre|moi|une|un|messe|messes|eglise|eglises|near|nearby|closest|close|around|pres|prÃ¨s|now|maintenant|proche|proximite|proximitÃ©|autour|anglais|english)\b/g;return String(text||'').replace(stop,' ').replace(/\s+/g,' ').trim()}
function parseUserIntent(q){
  ...
  const removePhrases=[
    ...
    'evening','soir','soiree','soirÃ©e','tonight','ce soir','morning','matin','afternoon','apres midi','aprÃ¨s-midi',
    ...
    'near me','nearby','nearby mass','mass nearby','closest','close to me','mass close to me','around me','near','pres de moi','prÃ¨s de moi','proche de moi','proche','a proximite','Ã  proximitÃ©','aux alentours','autour de moi',
    'mass','messe','church','eglise','Ã©glise'
  ];
...
function cleanVisibleQuery(q){
  ...
  s=semanticReplaceNormalized(s,['mass','messe','church','eglise','Ã©glise']);
  s=stripStopwords(s);
  return s.replace(/\s+/g,' ').trim()
}
function removeQueryIntent(q,k){
  ...
  if(k==='time')s=semanticReplaceNormalized(s,['evening','soir','soiree','soirÃ©e','tonight','ce soir','morning','matin','afternoon','apres midi','aprÃ¨s-midi']).replace(/\b\d{1,2}(?:h|:)?\d{0,2}\s*(pm|am)?\b/gi,' ');
...
function nearScopeNotice(scope=state.nearScope){
  if(scope==='20')return state.lang==='fr'?'Aucune messe trouvÃ©e Ã  moins de 12 km. Affichage des rÃ©sultats Ã  moins de 20 km.':'No nearby Mass found within 12 km. Showing results within 20 km.';
  if(scope==='all')return state.lang==='fr'?'Aucune messe trouvÃ©e Ã  moins de 20 km. Affichage des prochaines messes disponibles.':'No nearby Mass found within 20 km. Showing the next available Masses.';
  return '';
}
function nearRecommendationLabel(r,scope=state.nearScope,now=mauritiusNow()){
  if(!r)return '';
  if(scope==='20')return state.lang==='fr'?'Aucune messe Ã  moins de 12 km â€” recherche Ã©largie':'No Mass within 12 km â€” expanded search';
  if(scope==='all')return state.lang==='fr'?'Aucune messe Ã  moins de 20 km â€” affichage des prochaines messes disponibles':'No Mass within 20 km â€” showing next available Masses';
  const g=nearActionGroup(r,now);
  if(g===0)return state.lang==='fr'?'Messe la plus proche qui commence bientÃ´t':'Nearest Mass starting soon';
  if(g===1||g===2)return state.lang==='fr'?'Messe la plus proche aujourdâ€™hui':'Closest Mass today';
  if(g===3)return state.lang==='fr'?'Messe la plus proche demain':'Closest Mass tomorrow';
  return state.lang==='fr'?'Aucune messe proche bientÃ´t â€” affichage de lâ€™option la plus proche plus tard':'No nearby Mass soon â€” showing nearest later option';
}
...
function localizedRuleText(raw){
  ...
  if(kind==='second_friday_only')return _ruleLabel('Second Friday of the month only','DeuxiÃ¨me vendredi du mois seulement');
  if(kind==='third_friday_only')return _ruleLabel('Third Friday of the month only','TroisiÃ¨me vendredi du mois seulement');
  if(kind==='fourth_friday_only')return _ruleLabel('Fourth Friday of the month only','QuatriÃ¨me vendredi du mois seulement');
  ...
  if(kind==='second_sunday_only')return _ruleLabel('Second Sunday of the month only','DeuxiÃ¨me dimanche du mois seulement');
  if(kind==='third_sunday_only')return _ruleLabel('Third Sunday of the month only','TroisiÃ¨me dimanche du mois seulement');
  if(kind==='fourth_sunday_only')return _ruleLabel('Fourth Sunday of the month only','QuatriÃ¨me dimanche du mois seulement');
  if(kind==='third_fourth_wednesday_only')return _ruleLabel('Third and fourth Wednesday of the month only','TroisiÃ¨me et quatriÃ¨me mercredi du mois seulement');
  if(kind==='third_saturday_only')return _ruleLabel('Third Saturday of the month only','TroisiÃ¨me samedi du mois seulement');
  ...
  if(kind==='english_second_sunday')return _ruleLabel('English Mass on the second Sunday of the month','Messe en anglais le deuxiÃ¨me dimanche du mois');
  if(kind==='english_third_saturday')return _ruleLabel('English Mass on the third Saturday of the month','Messe en anglais le troisiÃ¨me samedi du mois');
  ...
  if(kind==='messe_ou_celebration')return _ruleLabel('Ambiguous: Mass or celebration','Ambigu : messe ou cÃ©lÃ©bration');
  if(kind==='celebration_word')return _ruleLabel('Celebration of the Word â€” not a Mass','CÃ©lÃ©bration de la Parole â€” pas une messe');
  if(kind==='celebration_laity')return _ruleLabel('Celebration led by laity â€” not a Mass','CÃ©lÃ©bration par des laÃ¯cs â€” pas une messe');
  if(kind==='celebration_montmartre')return _ruleLabel('Celebration at Chapelle du Montmartre â€” not a Mass','CÃ©lÃ©bration Ã  la chapelle du Montmartre â€” pas une messe');
  if(kind==='prayer_time')return _ruleLabel('Prayer time â€” not a Mass','Temps de priÃ¨re â€” pas une messe');
  ...
  if(kind==='adoration_only')return _ruleLabel('Adoration only â€” not a Mass','Adoration seulement â€” pas une messe');
  if(kind==='adoration')return _ruleLabel('Adoration','Adoration');
  if(kind==='other_celebration')return _ruleLabel('Other celebration â€” not a Mass','Autre cÃ©lÃ©bration â€” pas une messe');
  const text=String(raw||'').trim();
  if(_ruleLang()==='fr' && /[A-Za-z]/.test(text) && !/[Ã€-Ã¿]/.test(text))return 'Condition particuliÃ¨re â€” voir la source';
  return text;
}
function ruleText(r){
...
async function shareResult(r){const text=`${tr('shareMassIntro')}: ${visibleSiteName(r)} â€” ${dayName(r.day_of_week)} ${r.time_24h}`; await shareUrl(stateUrl({row:rowKey(r)}),visibleSiteName(r),text)}
...
function reportUrl(r){
  const subject=tr('reportSubject')+(r?' â€” '+siteName(r):'');
...
function renderResults(){
  ...
  if(state.mode==='saved'){
    const groups=savedGroups(); const n=groups.length; head.innerHTML=`<b>${n}</b> ${esc(n===1?tr('result'):tr('results'))} ${esc(tr('shown'))}<span class="sortHint"> Â· ${esc(state.near?tr('sortedHintNear'):tr('sortedHint'))}</span>`;
  ...
  const arr=state.results; const n=arr.length; head.innerHTML=`<b>${n}</b> ${esc(n===1?tr('result'):tr('results'))} ${esc(tr('shown'))}<span class="sortHint"> Â· ${esc(state.near?tr('sortedHintNear'):tr('sortedHint'))}</span>`;
  if(!n){
...
function renderFooter(){const f=$('#appFooter'); if(!f)return; f.innerHTML=`<span>${esc(tr('version'))} ${APP_VERSION}</span><span aria-hidden="true">â€¢</span><button type="button" data-footer-target="help">${esc(tr('helpTitle'))}</button><span aria-hidden="true">â€¢</span><button type="button" data-footer-target="install">${esc(tr('installTab'))}</button><span aria-hidden="true">â€¢</span><button type="button" data-footer-target="about">${esc(tr('about'))}</button><span aria-hidden="true">â€¢</span><button type="button" data-footer-target="update">${esc(tr('howUpdate'))}</button><span aria-hidden="true">â€¢</span><button type="button" data-footer-target="report">${esc(tr('reportIssue'))}</button>`;}
...
function renderStatic(){
  ...
  $('#heroCount').textContent=`${state.rows.length} ${state.lang==='fr'?'horaires':'schedules'} Â· ${new Set(state.rows.map(r=>r.parish_uid)).size} ${state.lang==='fr'?'paroisses':'parishes'}`;
  ...
  $('#closeDetail')?.setAttribute('aria-label',state.lang==='fr'?'Fermer les dÃ©tails':'Close details');
...
function runSearchDiagnostics(){const tests=['aprÃ¨s-midi Curepipe','matin Curepipe','soir Curepipe','messe aprÃ¨s-midi Curepipe','messe matin Curepipe','messe soir Curepipe','afternoon Curepipe','morning Curepipe','evening Curepipe','messe du soir Curepipe','evening Mass Curepipe','messe demain','messe aujourdâ€™hui','messe samedi soir','18h','18:00','6pm','sacre coeur','saint jean','st jean','Ã©glise','eglise']; const now=getMauritiusNow(new Date('2026-05-07T05:00:00+04:00')); return tests.map(q=>{const st={...state,query:q,filters:{...DEFAULT_FILTERS},mode:'search',near:false}; const out=getVisibleResults(st,now); return {query:q,count:out.results.length,top:out.results[0]?visibleSiteName(out.results[0]):null,pass:out.results.length>0}})}
...
function showInitFailure(e){
  try{
    ...
    const msg=(state&&state.lang==='fr')?'ProblÃ¨me de chargement de lâ€™application. Veuillez actualiser.':'App loading problem. Please refresh.';
